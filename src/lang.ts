const lang = {
  ...
  'LanguageFormatSettings': 'Language Format Settings',
  'LanguageFormat.TwoWayTranslation': 'Two-Way Translation',
  'LanguageFormat.EnableTwoWay': 'Enable 2-Way Translation',
  'LanguageFormat.YourLanguage': 'Your Language',
  'LanguageFormat.ClientLanguage': 'Client\'s Language',
  'LanguageFormat.LayoutStyle': 'Layout Style',
  'LanguageFormat.Languages': 'Languages',
  'LanguageFormat.LanguagesCaption': 'Your Language is what you read. Client\'s Language is what is sent to the other person.',
  'LanguageFormat.TwoWayCaption': 'Translate incoming and outgoing messages between your language and the client\'s language.',
